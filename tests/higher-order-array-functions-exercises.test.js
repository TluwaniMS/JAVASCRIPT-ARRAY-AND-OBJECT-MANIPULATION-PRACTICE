describe("Tests for Array Higher Order Functions", () => {
    test("Test-suite holder for Array Higher Order Functions", () => {
        expect(1).toEqual(1);
    });
    ...
    describe("Exercise 2 tests. (Higher Order Functions)", () => {
        ...
        //     const {
        //         returnPeopleThatAre18YearsOrOlder
        //     } = require("../exercises/higher-order-array-functions-exercises");
    ...
    describe("Exercise 3 tests. (Higher Order Functions)", () => {
        ...
        //             name: "Tshepo",
        //             surname: "Mailula",
        //             email: "Tshepo.Mailula@mock.com"
        //         },
        //         {
        //             name: "Daniel",
        //             surname: "Ntsoane",
        //             email: "Daniel.Ntsoane@mock.com"
        //         },
        //         {
        //             name: "Lethabo",
        //             surname: "Moseamo",
        //             email: "Lethabo.Moseamo@mock.com"
        //         },
        //         {
        //             name: "Skomoto",
        //             surname: "Cooper",
        //             email: "Skomoto.Cooper@mock.com"
        //         }
        //     ]);
        // });
    });
    ...
    describe("Exercise 4 tests. (Higher Order Functions)", () => {
        ...
        //     const {
        //         returnSummedTotalOfTheProductsPrices
        //     } = require("../exercises/higher-order-array-functions-exercises");
