describe("Tests for array exercises.", () => {
    test("Test-suite holder for array exercises", () => {
        expect(1).toEqual(1);
    });
    ...
    describe("Exercise 2 tests. (Array Exercises)", () => {
        ...
        //     const {
        //         returnArraySizeOfSecondElementInMainArray
        //     } = require("../exercises/array-exercises");
        ...
        //     const {
        //         addAnArrayToTheMainArrayWithNumberSevenAndEight
        //     } = require("../exercises/array-exercises");
        ...
        //     const {
        //         returnTheArraySizeOfTheFirstArrayElementInTheMainArray
        //     } = require("../exercises/array-exercises");
        //     const value =
        //         returnTheArraySizeOfTheFirstArrayElementInTheMainArray();
        //     expect(value).toEqual(4);
    ...
    describe("Exercise 3 tests. (Array Exercises)", () => {
        ...
        //     const {
        //         returnArrayContainingSixAndEight
        //     } = require("../exercises/array-exercises");
        ...
        //     const {
        //         addAnArrayWithElementsNineTwelveAndFifteen
        //     } = require("../exercises/array-exercises");
        ...
        //     const {
        //         returnArraySizeOfTheSecondArrayInTheSecondPosition
        //     } = require("../exercises/array-exercises");
